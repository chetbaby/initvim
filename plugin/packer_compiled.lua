...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    loaded = true,
    path = "/Users/chetbaby/.local/share/nvim/site/pack/packer/start/AutoSave.nvim",
  ...
  ["trouble.nvim"] = {
    ...
    loaded = true,
    path = "/Users/chetbaby/.local/share/nvim/site/pack/packer/start/trouble.nvim",
  ...
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/Users/chetbaby/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
